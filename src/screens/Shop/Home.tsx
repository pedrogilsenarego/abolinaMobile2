...
const Shop = () => {
  ...
  // const renderPageCollection = () => {
  //   return <PageCollection collection={collectionSelected} />;
  // };

  // const renderSearchShop = () => {
  //   return (
  ...
  //     break;
  //   case "pageCollection":
  //     content = renderPageCollection();
  //     break;
  //   case "search":
  //     content = renderSearchShop();
  //     break;
  //   default:
  //     content = renderMainPage();
  //     break;
